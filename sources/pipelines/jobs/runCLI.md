...
* If the runCLI job has `allowPublicAccess` set to true, the job will be accessible to all public users with a link to the job. Similarly setting `allowPublicAccess` to false, will make the as private and will be accessible only to owners and collaborators of the project.

* By default any runCLI job with no `allowPublicAccess` defined, will be treated as private and will be accessible only to owners and collaborators of the project.
...
* The link to the runCLI job can be obtained from notifications and will look UI will look something like this.

<img src="../../images/jobs/publicrunclijob.png" alt="Public RunCLI Job" style="width:1200px;vertical-align: middle;display: block;margin-left: auto;margin-right: auto;"/>
