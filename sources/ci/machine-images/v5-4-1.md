page_title: Description of what is available in Machine Image v5.4.1
...
* **[Default for `language: java` yml config]**[dry-dock/u16javall:v5.4.1](https://github.com/dry-dock/u16javall): Ubuntu 16.04 image with Java
